package com.zy.spring.mildware.netty.netty11.bootstrap;

import com.zy.spring.mildware.netty.netty11.codec.CustomMessageDecoder;
import com.zy.spring.mildware.netty.netty11.codec.CustomMessageEncoder;
import com.zy.spring.mildware.netty.netty11.constant.Command;
import com.zy.spring.mildware.netty.netty11.handler.BizRespHandler;
import com.zy.spring.mildware.netty.netty11.handler.HandshakeReqHandler;
import com.zy.spring.mildware.netty.netty11.handler.HeartBeatReqHandler;
import com.zy.spring.mildware.netty.netty11.handler.TailHandler;
...
public class CustomNettyClient {
    ...
    public CustomNettyClient(String host, int port) {
    ...
    public synchronized void connection(String host, int port) {
        ...
        synchronized (CustomNettyClient.class){
            if (init) {
                    ...
                    .handler(new ChannelInitializer<SocketChannel>() {
                        ...
                        protected void initChannel(SocketChannel socketChannel) throws Exception {
                            socketChannel.pipeline()
                                    ...
                                    .addLast("XiaotMessageDecoder", new CustomMessageDecoder(1024 * 1024, 0, 4))
                                    //消息编码器
                                    .addLast("XiaotMessageEncoder", new CustomMessageEncoder())
                                    //握手请求处理器
