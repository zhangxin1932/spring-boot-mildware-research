...
public class BizReqHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (receiveMsg != null && receiveMsg.getHeader() != null && Command.BIZ_REQ.getVal() == receiveMsg.getHeader().getCommand()) {
            ...
            ServiceLoader<CustomServerBizReqCallbackProvider> loader = ServiceLoader.load(CustomServerBizReqCallbackProvider.class);
            for (CustomServerBizReqCallbackProvider service : loader) {
